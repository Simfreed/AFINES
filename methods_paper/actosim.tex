...
Force propogation onto minifilaments is done using the lever rule described in \Cref{eqn:lever}.
\par
...
number ($Re \approx 4*10^{-7}$) we treat the dynamics as overdamped and set $m=0$ in \Cref{eqn:lang}.
