...
\begin{figure}[H]  
  \centering
  \includegraphics[width=\textwidth]{figs/minimal_white.pdf}
  \caption{
  \label{fig:toys}%
...
\begin{equation}
  ...
  \label{eqn:evans}
\end{equation}
for the $x$ component of equation \Cref{eqn:lang} for the actin beads 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=1.2]{figs/shear_result_white.pdf}
  \caption{%
    \label{fig:stress}%
...
\end{verbatim}
When all other parameters were left as defaults (see \Cref{tab:options}),
...
\begin{table}
  ...
  \label{tab:options}
\end{table}
\section{Derivation of \Cref{eqn:sllod}}
...
\end{eqnarray}
Comparing with \Cref{eqn:lang} for Langevin dynamics, we can substitute 
...
\cite{evans1984} becomes a combination of \Cref{eqn:overdamped,eqn:sllod}. 
\section{Stability of Filament Model}
While the only 
\begin{figure}[H]
  \centering
  \includegraphics{figs/pl_supp.pdf}
