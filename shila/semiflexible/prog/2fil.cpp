 ...
 ***********************/
    ...
    int print_dt     = 100;  // # of timesteps to print to file
    ...
    double apos1[3] = {-10, 0.5, 0};
    double apos2[3] = {10, -0.5, pi};
    double apos3[3] = {0.5, -10, pi/2};
    double apos4[3] = {-0.5, 10, 3*pi/2};

    double mpos1[3] = {0, 0, pi/2};
    double mpos2[3] = {0, 0, 0};
    
    actin_positions.push_back(apos1);
    actin_positions.push_back(apos2);
    actin_positions.push_back(apos3);
    actin_positions.push_back(apos4);
    
    motor_positions.push_back(mpos1);
    motor_positions.push_back(mpos2);
...
//  double link_bending_stiffness = motor_stiffness/10;
    ...
    actin_ensemble * net = new
        actin_ensemble(actin_density,xrange,yrange,xgrid,ygrid,actin_length,viscosity,nmonomer,link_length, actin_positions, seed);
